...
Replaces tabs/spaces/newlines as needed so Jupyter renders poems correctly.
"""
import re
...
class ArabicCleaner:
    def __init__(self):
        ...
        # This covers Arabic diacritics and marks in Unicode range 064B-065F
        self.tashkeel_pattern = re.compile(r'[\\u064B-\\u065F]')
        # Tashkeel removal regex
        # Remove Arabic diacritics (harakat) including fatha, damma, sukun, etc.
        
        # Tatweel (Kashida) - stretched Alif
        self.tatweel_pattern = re.compile(r'\\u0640')
        
        # Common Arabic punctuation marks to strip
        # Includes Arabic comma, semi-colon, question mark, quotation marks, etc.
    ...
    def clean_for_search(self, text: str) -> str:
        ...
        # This helps strip hidden markers or invisible Unicode control chars
